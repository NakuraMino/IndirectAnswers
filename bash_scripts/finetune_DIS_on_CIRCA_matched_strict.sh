...
## File for finetuning the DIS model on the matched, strict version of the CIRCA dataset
...
## For label of size 9
echo "Finetuning DIS CIRCA with matched, strict labels..."
...
python finetuning.py \
    ...
    --model_name "DIS_CIRCA_BERT_matched_strict_e3_lr${lr}_b32" \
    --dataset_type "CIRCA" \
    --multi_gpu_on \
    --transfer_on \
    --batch_size "32" \
...
echo "Finished finetuning DIS CIRCA with matched, strict labels..."
