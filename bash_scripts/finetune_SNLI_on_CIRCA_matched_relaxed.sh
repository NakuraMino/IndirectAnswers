...
## For label of size 6
echo "Finetuning on SNLI CIRCA with matched, relaxed labels..."
...
python finetuning.py \
    ...
    --model_name "SNLI_CIRCA_BERT_matched_relaxed_e3_lr${lr}_b32" \
    --dataset_type "CIRCA" \
    --multi_gpu_on \
    --transfer_on \
    --batch_size "32" \
...
echo "Finished finetuning SNLI CIRCA with matched, relaxed labels..."
