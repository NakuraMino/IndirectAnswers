...
echo "Testing BOOLQ CIRCA on CIRCA with matched, strict labels..."

# Evaluate on test dataset
python MNLItesting.py \
--test_data "$BASE_DIR/data/CIRCA/circa-data-test.tsv" \
--model_type "$BASE_DIR/models/BOOLQ_CIRCA_BERT_matched_strict_e3_lr5e-5_b32" \
--dataset_type "CIRCA" \
--dataset_mode "qa" \
--batch_size "32" \
--num_labels "9" \
...
echo "Finished testing BOOLQ CIRCA with matched, strict labels..."
