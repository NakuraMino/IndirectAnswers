...
echo "Testing DIS CIRCA on CIRCA with matched, relaxed labels..."

# Evaluate on test dataset
python MNLItesting.py \
--test_data "$BASE_DIR/data/CIRCA/circa-data-test.tsv" \
--model_type "$BASE_DIR/models/DIS_CIRCA_BERT_matched_relaxed_e3_lr5e-5_b32" \
--dataset_type "CIRCA" \
--dataset_mode "qa" \
--batch_size "32" \
--num_labels "6" \
...
echo "Finished testing DIS CIRCA with matched, relaxed labels..."
